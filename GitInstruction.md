...
### Что такое удаленный репозиторий и для чего он нужен
  ...
  Удобен тем, что:
  * Его можно "выкачать" и работать с ним локально
  * В него можно передать свои коммиты из локального репозитория, чтобы остальные программисты могли их увидеть
